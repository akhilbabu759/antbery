...
class SelfTabBarViewWidget extends StatelessWidget {
  const SelfTabBarViewWidget({
    super.key,
  });
  ...
  Widget build(BuildContext context) {
    ...
    return  BlocBuilder<SelfBookBloc, SelfBookState>(builder: (context, stat) {
            if (stat is SelfbookLoding) {
              return Center(
